      ...
      <header className="bg-white pt-16 pb-10 px-8 sticky top-0 z-40 border-b border-slate-100 rounded-b-[4rem] shadow-sm">
        <div className="flex justify-between items-center mb-10">
          <div className="flex items-center gap-6">
            ...
            <div>
               <p className="text-[11px] font-black text-slate-400 uppercase tracking-[0.25em] leading-none mb-2">Smart Health</p>
      ...
      {isSettingsOpen && (
        <div className="fixed inset-0 z-[110] flex items-end justify-center">
          ...
          <div className="relative bg-white w-full rounded-t-[6rem] p-16 animate-in slide-in-from-bottom duration-700 shadow-2xl">
            ...
            <button onClick={() => setIsSettingsOpen(false)} className="w-full bg-slate-900 text-white py-10 rounded-[3rem] font-black uppercase text-[14px] tracking-[0.5em] active:scale-95 transition-all shadow-xl">შენახვა</button>
          </div>
        </div>
      )}
    </div>
